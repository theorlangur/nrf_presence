#!/bin/bash
source /home/theorlangur/ncs/toolchains/fbf7391cab/gcc16_cross_compile_human_env.sh
west build --build-dir build_ezurio_gcc16_human . -t menuconfig \
    ...
    -DCMAKE_TOOLCHAIN_FILE=/home/theorlangur/ncs/toolchains/fbf7391cab/gcc16_cross_compile_human.cmake \
